...
const points = [
  <div key={1} className="flex flex-col w-full items-center">
    ...
    <div className=" max-w-[400px] font-semibold w-[100vw] point animation animation-2 text-justify   -translate-y-[130%] p-10 py-20 max-sm:-translate-x-0  -translate-x-20">
  ...
  <div key={2} className="flex flex-col  items-center">
    ...
    <div className=" -translate-y-[125%] font-semibold max-w-[400px] point animation text-justify animation-3 z-10 p-10 py-10 translate-x-20 max-sm:-translate-x-0">
...
function About() {
  ...
  return (
    <div className="max-sm:mx-5 my-8">
      <div className="flex  justify-center">
        <div className="flex flex-col items-center gap-14 max-w-[800px] w-[100vw]">
          <div className=" flex flex-col justify-center  max-sm:p-5 max-w-[100vw]">
            ...
            <div className="text-justify text-lg max-sm:text-sm">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex w-full items-center">
              ...
              >
                <ChevronDoubleLeftIcon
                  className="mx-auto w-[250px] text-gray-300 dark:text-sky-300 "
                  aria-hidden="true"
                />
              </div>
              <div
              ...
              >
                <div className=" w-full text-lg text-sky-300 ">{points[i]}</div>
              </div>
              <div
                className="flex items-center w-10 max-sm:hidden h-full z-40"
                onClick={() => handlePoint(1)}
      ...
      <div className="flex items-center  bg-black-100 bg-opacity-50 p-4 gap-10 my-14">
        <div className="flex flex-col  items-center">
          ...
          <div className="mt-6 border border-transparent bg-sky-100 font-bold hover:bg-black-1010   hover:border-sky-400  rounded-md p-3 text-xl text-center max-sm:text-base text-sky-800 hover:text-sky-300">
            <Link href={"/libros"}>
              Ir a la bibliocteca virtual de C.A.Tac.Pol. <span aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </div>

        <div className="body max-sm:hidden rounded-lg "></div>
      </div>
    </div>
  );
}
